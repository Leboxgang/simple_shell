...
/* set_info: Sets up the info_t struct with command line arguments
...
/* free_info: Frees the dynamically allocated fields in info_t struct
 * @info: Pointer to the struct to be freed
 * @all: If true, free all fields; otherwise, free selective fields
 */
